...
def logo ():
   ...
   konsol.print(f"\t\t[bold blue]@keyifRobot[/] [yellow]:bird:[/]\t[bold red]Python: [/][i]{surum}[/]")

def baslangic():
   logo()
   basarili(f"keyifRobot v{__version__} pyrogram tabanında çalışıyor, {layer} katman başlatıldı...\n\n")